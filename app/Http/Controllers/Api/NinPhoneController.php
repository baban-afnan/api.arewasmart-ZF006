    ...
    public function store(Request $request)
    {
        try {
            ...
            try {
                ...
                // Adjust extraction based on actual response structure of new endpoint
                $apiData = $data['data']['data'] ?? $data['data'] ?? $data ?? [];
                
                // Modyfing mapping for Phone response (assuming similar structure to Demo or generic identity data)
                // If specific fields are returned for Phone verification, they should be mapped here.
                // Assuming standard fields like firstname, surname, etc. are returned.
                ...
                DB::rollBack();
                Log::error('NIN Phone Transaction Error: ' . $e->getMessage());
                throw $e;
            }
