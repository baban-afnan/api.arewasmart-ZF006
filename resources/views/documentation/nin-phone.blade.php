...
@section('content')
    <div class="mb-5">
        ...
        <h1 class="display-5 fw-bold  mb-3">NIN Phone Verification</h1>
        <p class="lead text-muted">Verify a National Identity Number (NIN) utilizing the phone number linked to the user's identity records.</p>
    </div>
        ...
        <div class="card-body p-0">
            <div class="bg-soft-primary p-4 d-flex align-items-center justify-content-between flex-wrap gap-3">
                <div class="d-flex align-items-center">
                    ...
                    <code class="text-primary fw-bold fs-15 font-monospace">/api/v1/nin-phone</code>
                </div>
                <button class="btn btn-white btn-sm rounded-pill px-3 shadow-sm" onclick="copyToClipboard('{{ url('/') }}/api/v1/nin-phone')">
            ...
            <table class="table table-hover align-middle mb-0">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>Linked phone number (e.g., 08012345678).</td>
    ...
    <div class="row g-4 mb-5">
        <div class="col-lg-12">
            <div class="card border-0 shadow-lg rounded-4 overflow-hidden bg-dark">
                ...
                <div class="card-body p-0">
<pre class="m-0 p-4 font-monospace small"><code class="text-white">curl -X POST "{{ url('/') }}/api/v1/nin-phone" \
  ...
  -d "<span class="text-info">phone</span>=<span class="text-warning">08012345678</span>"</code></pre>
                </div>
            </div>
        </div>
