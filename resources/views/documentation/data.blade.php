...
@section('content')
    <div class="mb-5">
        ...
        <h1 class="display-5 fw-bold  mb-3">Data Subscription</h1>
        <p class="lead text-muted">Purchase corporate and regular data bundles for your users across all major networks seamlessly.</p>
    </div>
        ...
        <div class="card-body p-0">
            <div class="bg-soft-primary p-4 d-flex align-items-center justify-content-between flex-wrap gap-3">
                <div class="d-flex align-items-center">
                    ...
                    <code class="text-primary fw-bold fs-15 font-monospace">/api/v1/data</code>
                </div>
                <button class="btn btn-white btn-sm rounded-pill px-3 shadow-sm" onclick="copyToClipboard('{{ url('/') }}/api/v1/data')">
            ...
            <table class="table table-hover align-middle mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>The unique ID of the data plan. <em>Check <a href="{{ route('docs.pricing') }}">Pricing</a> for IDs.</em></td>
                        <td class="text-end pe-4"><span class="badge bg-danger text-white px-2 py-1 rounded">Required</span></td>
                    </tr>
                    <tr>
