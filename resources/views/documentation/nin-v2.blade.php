...
@section('content')
    <div class="mb-5">
        ...
        <h1 class="display-5 fw-bold  mb-3">NIN V2 Verification</h1>
        <p class="lead text-muted">Verify a National Identity Number (NIN) utilizing the NIN linked to the user's identity records.</p>
    </div>
            ...
            <table class="table table-hover align-middle mb-0">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>Linked NIN (e.g., 08012345678).</td>
