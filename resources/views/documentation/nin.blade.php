...
@section('content')
    <div class="mb-5">
        ...
        <h1 class="display-5 fw-bold  mb-3">NIN Verification</h1>
        <p class="lead text-muted">The NIN Verification endpoint allows you to verify the identity of individuals using their 11-digit National Identity Number.</p>
    </div>
        ...
        <div class="card-body p-0">
            <div class="bg-soft-primary p-4 d-flex align-items-center justify-content-between flex-wrap gap-3">
                <div class="d-flex align-items-center">
                    ...
                    <code class="text-primary fw-bold fs-15 font-monospace">/api/v1/nin</code>
                </div>
                <button class="btn btn-white btn-sm rounded-pill px-3 shadow-sm" onclick="copyToClipboard('{{ url('/') }}/api/v1/nin')">
        ...
        <div class="col-lg-12">
            <div class="card border-0 shadow-lg rounded-4 overflow-hidden bg-dark">
                <div class="card-header bg-white bg-opacity-10 border-bottom border-white border-opacity-10 py-3 d-flex justify-content-between align-items-center">
                    <h6 class="fw-bold text-white mb-0">Standard Integration (PHP cURL)</h6>
                    <span class="badge bg-primary">PHP</span>
                </div>
                <div class="card-body p-0">
<pre class="m-0 p-4 font-monospace small"><code class="text-white">&lt;?php

$curl = curl_init();

curl_setopt_array($curl, array(
  CURLOPT_URL => '{{ url('/') }}/api/v1/nin',
