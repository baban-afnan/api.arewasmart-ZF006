...
@section('content')
    <div class="mb-5">
        ...
        <h1 class="display-5 fw-bold  mb-3">NIN DEMO Verification</h1>
        <p class="lead text-muted">Test the basic NIN verification process using our DEMO endpoint without incurring real charges or needing real NIN records during development.</p>
    </div>
        ...
        <div class="card-body p-0">
            <div class="bg-soft-primary p-4 d-flex align-items-center justify-content-between flex-wrap gap-3">
                <div class="d-flex align-items-center">
                    ...
                    <code class="text-primary fw-bold fs-15 font-monospace">/api/v1/nin-demo</code>
                </div>
                <button class="btn btn-white btn-sm rounded-pill px-3 shadow-sm" onclick="copyToClipboard('{{ url('/') }}/api/v1/nin-demo')">
    ...
    <div class="row g-4 mb-5">
        <div class="col-lg-12">
            <div class="card border-0 shadow-lg rounded-4 overflow-hidden bg-dark">
                ...
                <div class="card-body p-0">
<pre class="m-0 p-4 font-monospace small"><code class="text-white">curl -X POST "{{ url('/') }}/api/v1/nin-demo" \
  ...
  -d "<span class="text-info">nin</span>=<span class="text-warning">11111111111</span>"</code></pre>
                </div>
            </div>
        </div>
            ...
            <div class="card border-0 shadow-lg rounded-4 overflow-hidden bg-dark">
                <div class="card-header bg-white bg-opacity-10 border-bottom border-white border-opacity-10 py-3">
                    <h6 class="fw-bold text-success mb-0 d-flex align-items-center">
                        <i class="ti ti-circle-check me-2 fs-15"></i> Success Response (Demo)
                    </h6>
                </div>
                <div class="card-body p-0">
