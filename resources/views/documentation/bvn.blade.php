...
@section('content')
    <div class="mb-5">
        ...
        <h1 class="display-5 fw-bold  mb-3">BVN Verification</h1>
        <p class="lead text-muted">The BVN endpoint enables you to verify the identity of users via their 11-digit Bank Verification Number linked to their bank accounts.</p>
    </div>
        ...
        <div class="card-body p-0">
            <div class="bg-soft-primary p-4 d-flex align-items-center justify-content-between flex-wrap gap-3">
                <div class="d-flex align-items-center">
                    ...
                    <code class="text-primary fw-bold fs-15 font-monospace">/api/v1/bvn</code>
                </div>
                <button class="btn btn-white btn-sm rounded-pill px-3 shadow-sm" onclick="copyToClipboard('{{ url('/') }}/api/v1/bvn')">
    ...
    <div class="card border-0 shadow-sm rounded-4 overflow-hidden mb-5">
        <div class="table-responsive">
            <table class="table table-hover align-middle mb-0">
                ...
                <tbody>
                    <tr>
                        <td class="ps-4"><code class="text-primary fw-bold">bvn</code></td>
    ...
    <div class="row g-4 mb-5">
        <div class="col-lg-12">
            <div class="card border-0 shadow-lg rounded-4 overflow-hidden bg-dark">
                ...
                <div class="card-body p-0">
<pre class="m-0 p-4 font-monospace small"><code class="text-white">curl -X POST "{{ url('/') }}/api/v1/bvn" \
  ...
  -d "<span class="text-info">bvn</span>=<span class="text-warning">01234567890</span>"</code></pre>
                </div>
            </div>
        </div>
