<x-app-layout>
    <div class="content container-fluid">
        ...
        <div class="page-header mb-4">
            <div class="row align-items-center">
                <div class="col">
                    <h3 class="page-title fw-bold text-primary">TIN Registration API</h3>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('dashboard') }}" class="text-muted">Dashboard</a></li>
                        <li class="breadcrumb-item active text-primary">TIN API Documentation</li>
                    </ul>
                </div>
                <div class="col-auto">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-4 mb-4 mb-md-0" id="sidebarColumn">
                <div class="card border-0 shadow-sm rounded-4 sidebar-card" style="top: 100px; z-index: 1020;">
                    ...
                    <div class="card-body p-3">
                        <h6 class="text-secondary text-uppercase small fw-bold mb-3 ms-2 ls-1 d-none d-lg-block">On This Page</h6>
            ...
            <div class="col-lg-9 col-md-12" id="mainContent">
                ...
                @if(session('status'))
                    <div class="alert alert-{{ session('status') == 'success' ? 'success' : 'danger' }} alert-dismissible fade show shadow-sm border-0 mb-4 rounded-3" role="alert">
                        <div class="d-flex align-items-center">
                            <i class="ti ti-{{ session('status') == 'success' ? 'check' : 'alert-circle' }} me-2 text-white fs-4"></i>
                    ...
                    <div class="card border-0 shadow-sm rounded-4 overflow-hidden mb-4">
                        <div class="card-header bg-white border-bottom py-4">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <h4 class="card-title mb-0 fw-bold text-dark">Introduction</h4>
                                    <p class="card-subtitle mb-0 text-muted">TIN Registration Service Integration</p>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="d-flex align-items-start">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <div class="bg-white border rounded p-3 mt-2 shadow-sm">
                                            <code class="text-dark fw-bold fs-15">{{ url('/') }}/api/v1</code>
                                        </div>
                ...
                <div class="docs-section d-none" id="auth">
                    <div class="card border-0 shadow-sm rounded-4 overflow-hidden mb-4">
                        <div class="card-header bg-white border-bottom py-3">
                            <h5 class="fw-bold text-dark mb-0"><span class="badge bg-dark rounded-circle me-2 text-white">1</span>Authentication</h5>
                        </div>
                        <div class="card-body p-4">
                            ...
                            <div class="mb-4">
                                <label class="form-label fw-bold text-primary mb-2 text-uppercase small ls-1">
                                    Your API Token
                                </label>
                                <div class="input-group input-group-lg">
                                    ...
                                    <input type="text" 
                                           class="form-control font-monospace border-start-0 bg-white text-dark mt-2" 
                                           value="{{ Auth::user()->api_token }}" 
                                           id="apiToken" 
                                           readonly>
                                    <button class="btn btn-primary px-4" type="button" onclick="copyToken()">
                                        <i class="ti ti-copy me-2 text-white"></i> Copy
                                    </button>
                                </div>
                    ...
                    <div class="d-flex justify-content-between mt-4">
                        <button class="btn btn-secondary d-inline-flex align-items-center prev-tab-btn" data-prev="overview">
                            <i class="ti ti-arrow-left me-2 text-white"></i> Previous
                        </button>
                ...
                <div class="docs-section d-none" id="endpoint">
                    <div class="card border-0 shadow-sm rounded-4 overflow-hidden mb-4">
                        <div class="card-header bg-white border-bottom py-3">
                            <h5 class="fw-bold text-dark mb-0"><span class="badge bg-dark rounded-circle me-2 text-white">2</span>Verify TIN Endpoint</h5>
                        </div>
                        <div class="card-body p-4">
                            <div class="card border-0 shadow-none bg-soft-primary mb-4">
                                <div class="card-body d-flex align-items-center p-3">
                                    ...
                                    <code class="text-dark fs-20 fw-bold">{{ url('/') }}/api/v1/tin/verify</code>
                                </div>
                            </div>

                            <p class="text-muted mb-4">
                                <i class="ti ti-user-check me-1"></i>
                                Register/Verify TIN by sending a POST request. Supports both Individual (NIN-based) and Corporate (RC-based) registrations.
                            </p>
                            ...
                            <div class="row g-4">
                                    ...
                                    <div class="card border bg-white h-100 rounded-3">
                                        <div class="card-header bg-white border-bottom py-3">
                                            <h6 class="fw-bold mb-0 text-primary">
                                                <i class="ti ti-settings me-2 text-white"></i> Request Headers
                                            </h6>
                                        </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="card border bg-white h-100 rounded-3">
                                        <div class="card-header bg-white border-bottom py-3">
                                            <h6 class="fw-bold mb-0 text-primary">
                                                <i class="ti ti-input-check me-2 text-white"></i> Request Body Options
                                            </h6>
                                        </div>
                                        <div class="card-body p-3">
                                            <h6 class="text-muted small fw-bold text-uppercase mb-2">Option 1: Corporate (RC)</h6>
                                            <p class="small text-muted mb-2">
                                                <strong>type values:</strong><br>
                                                1 = Business Name<br>
                                                2 = Company<br>
                                                3 = Incorporated Trustee<br>
                                                4 = Limited Partnership<br>
                                                5 = Limited Liability Partnership
                                            </p>
                                            <pre class="bg-light p-3 mb-3 border rounded"><code class="language-json">{
    "type": "2",
    "rc": "8891227"
}</code></pre>
                                            <h6 class="text-muted small fw-bold text-uppercase mb-2">Option 2: Individual (NIN)</h6>
                                            <pre class="bg-light p-3 m-0 border rounded"><code class="language-json">{
  "nin": "51307511444",
  "firstName": "SHAFIU",
  "lastName": "MUHAMMAD",
  "dateOfBirth": "22/02/2002"
                ...
                <div class="docs-section d-none" id="responses">
                    <div class="card border-0 shadow-sm rounded-4 overflow-hidden mb-4">
                        <div class="card-header bg-white border-bottom py-3">
                            <h5 class="fw-bold text-dark mb-0"><span class="badge bg-dark rounded-circle me-2 text-white">3</span>API Responses</h5>
                        </div>
                        <div class="card-body p-4">
                            <div class="row g-4">
                                <!-- Success Response Corporate -->
                                <div class="col-lg-12">
                                    <div class="card border-0 shadow-sm rounded-3 mb-3">
                                        <div class="card-header bg-soft-success border-bottom-0 py-2">
                                            <div class="d-flex align-items-center">
                                                <i class="ti ti-circle-check text-success me-2 text-white fs-5"></i>
                                                <h6 class="mb-0 fw-bold text-success">Success Response (Corporate)</h6>
                                            </div>
                                        </div>
                                        <div class="card-body p-0">
    ...
    "data": {
        "company_name": "MUSA MANAGER ENTERPRISE LTD",
        "rc": "8891227",
        "tax_id": "2622180459884",
        "type": "2"
    },
    "message": "Success",
    "status": 200,
    "success": true,
    "transaction_ref": "Ver-172938475-123",
    "charge": {{ number_format($verificationPrice ?: 100, 2) }}
}</code></pre>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="card border-0 shadow-sm rounded-3 mb-3">
                                        <div class="card-header bg-soft-success border-bottom-0 py-2">
                                            <div class="d-flex align-items-center">
                                                <i class="ti ti-circle-check text-success me-2 text-white fs-5"></i>
                                                <h6 class="mb-0 fw-bold text-success">Success Response (Individual)</h6>
                                            </div>
                                        </div>
                                        <div class="card-body p-0">
                                            <pre class="bg-dark text-light p-3 mb-0 shadow-inner custom-scrollbar" style="max-height: 400px; overflow-y: auto;"><code class="language-json">{
    "data": {
        ...
        "lastName": "MUHAMMAD",
        "nin": "51307511444",
        "tax_id": "2512104317591",
        "tax_residency": "Kebbi State"
    },
    "message": "Success",
    "status": 200,
    "success": true,
    "transaction_ref": "Ver-172938475-126",
    "charge": {{ number_format($verificationPrice ?: 100, 2) }}
}</code></pre>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="card border-0 shadow-sm rounded-3">
                                        <div class="card-header bg-soft-danger border-bottom-0 py-2">
                                            <div class="d-flex align-items-center">
                                                <i class="ti ti-circle-x text-danger me-2 text-white fs-5"></i>
    ...
    @push('scripts')
    <script>
        // Tab switching logic (Same as NIN)
        ...
        function showNotification(message, type) {
            ...
            notification.innerHTML = `
                <div class="d-flex align-items-center">
                    <i class="ti ti-${type === 'success' ? 'check' : 'alert-circle'} me-2 text-white fs-4"></i>
