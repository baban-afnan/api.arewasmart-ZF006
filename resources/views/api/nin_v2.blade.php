<x-app-layout>
    <title>Arewa Smart - {{ $title ?? 'NIN V2 Verification API' }}</title>
            ...
            <div class="row align-items-center">
                <div class="col">
                    ...
                    <p class="text-muted mb-0">
                        View and manage NIN V2 Verification API requests
                    </p>
                </div>
                ...
                <div class="docs-section fade-in" id="overview">
                    <div class="card border-0 shadow-sm rounded-4 mb-4 position-relative overflow-hidden">
                        ...
                        <div class="card-body p-5 position-relative">
                            ...
                            <h2 class="fw-bold  mb-3">NIN V2 Verification Integration</h2>
                            <p class="text-muted lead mb-4">
                                Our NIN V2 verification service allows you to retrieve identity details efficiently.
                            </p>
                            ...
                            <div class="card border-0 bg-soft-primary mb-4 overflow-hidden">
                                <div class="card-body d-flex align-items-center justify-content-between p-4 flex-wrap gap-2">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <code class="text-primary fw-bold fs-18 text-break">{{ url('/') }}/api/v1/nin/v2</code>
                                    </div>
                                </div>
                            </div>

                            <p class="text-muted mb-4">
                                Verify identity details by providing a valid NIN.
                            </p>
...
<pre class="m-0 p-4 text-white font-monospace"><code>{
  ...
  <span class="text-info">"message"</span>: <span class="text-warning">"NIN V2 Verification Successful"</span>,
  <span class="text-info">"data"</span>: {
    <span class="text-info">"reference"</span>: <span class="text-warning">"NINV212345ABC"</span>,
