<x-app-layout>
    <div class="content container-fluid">
        ...
        <div class="page-header mb-4">
            <div class="row align-items-center">
                <div class="col">
                    <h3 class="page-title fw-bold text-primary">NIN Verification API</h3>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('dashboard') }}" class="text-muted">Dashboard</a></li>
                        <li class="breadcrumb-item active text-primary">NIN API Documentation</li>
                    </ul>
                </div>
                <div class="col-auto">
        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-md-12" id="mainContent">
                        ...
                        <div class="card-header bg-white border-bottom py-4">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <p class="card-subtitle mb-0 text-muted">NIN Verification Service Integration</p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="docs-section d-none" id="endpoint">
                    <div class="card border-0 shadow-sm rounded-4 overflow-hidden mb-4">
                        <div class="card-header bg-white border-bottom py-3">
                            <h5 class="fw-bold text-dark mb-0"><span class="badge bg-dark rounded-circle me-2 text-white">2</span>Verify NIN Endpoint</h5>
                        </div>
                        <div class="card-body p-4">
                            <div class="card border-0 shadow-none bg-soft-primary mb-4">
                                <div class="card-body d-flex align-items-center p-3">
                                    ...
                                    <code class="text-dark fs-20 fw-bold">{{ url('/') }}/api/v1/nin/verify</code>
                                </div>
                            </div>

                            <p class="text-muted mb-4">
                                <i class="ti ti-user-check me-1"></i>
                                Verify a National Identity Number (NIN) by sending a POST request.
                            </p>
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-lg-6">
                                    <div class="card border bg-white h-100 rounded-3">
                                        <div class="card-header bg-white border-bottom py-3">
                                            <h6 class="fw-bold mb-0 text-primary">
                                                <i class="ti ti-input-check me-2 text-white"></i> Request Body
                                            </h6>
                                        </div>
                                        <div class="card-body p-0">
                ...
                <div class="docs-section d-none" id="responses">
                    <div class="card border-0 shadow-sm rounded-4 overflow-hidden mb-4">
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="alert alert-soft-warning border-start border-4 border-warning p-3 mb-4 rounded-3">
                                <div class="d-flex align-items-start">
                                    <i class="ti ti-info-circle text-warning me-3 mt-1 fs-4"></i>
                                    <div>
                                        <h6 class="alert-heading fw-bold mb-1 text-warning">Billing Policy & Response Codes</h6>
                                        <p class="mb-0 text-dark small">
                                            Please note that some responses are chargeable even if the NIN is not found. See the table below for details.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card border mb-4 rounded-3 overflow-hidden">
                                <div class="card-header bg-light border-bottom py-2 px-3">
                                    <h6 class="fw-bold mb-0 text-dark small text-uppercase">Response Codes</h6>
                                </div>
    ...
    "status": "error",
    "message": "The nin must be 11 digits.",
    "response_code": "422"
}</code></pre>
                                        </div>
                                    </div>
