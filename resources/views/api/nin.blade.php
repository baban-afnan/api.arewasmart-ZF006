<x-app-layout>
    <title>Arewa Smart - {{ $title ?? 'NIN Verification API' }}</title>
            ...
            <div class="row align-items-center">
                <div class="col">
                    ...
                    <p class="text-muted mb-0">
                        View and manage NIN Verification API requests
                    </p>
                </div>
                            ...
                            <div class="card-body p-0">
                                ...
                                <div class="list-group list-group-flush custom-sidebar-nav p-3">
                                    ...
                                    <a class="list-group-item list-group-item-action border-0 mb-2 px-3 py-2 d-flex align-items-center" href="#endpoint" onclick="switchTab('endpoint'); return false;">
                                        <i class="ti ti-server me-2 opacity-75 fs-15"></i> Verify Endpoint
                                    </a>
                ...
                <div class="offcanvas-body p-0">
                    <div class="list-group list-group-flush custom-sidebar-nav p-3">
                        ...
                        <a class="list-group-item list-group-item-action border-0 mb-2 px-3 py-2 d-flex align-items-center" href="#endpoint" onclick="switchTab('endpoint'); closeOffcanvas(); return false;">
                            <i class="ti ti-server me-2 fs-15"></i> Verify Endpoint
                        </a>
                    ...
                    <div class="card border-0 shadow-sm rounded-4 mb-4 position-relative overflow-hidden">
                        ...
                        <div class="card-body p-5 position-relative">
                            ...
                            <p class="text-muted lead mb-4">
                                Seamlessly integrate our robust NIN Verification service into your application. 
                ...
                <div class="docs-section d-none fade-in" id="auth">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <button class="btn btn-primary d-inline-flex btn-lg align-items-center shadow-sm next-tab-btn" data-next="endpoint">
                            Next: Verify Endpoint <i class="ti ti-arrow-right ms-2 fs-15"></i>
                        </button>
                    </div>
                </div>
                            ...
                            <div class="card border-0 bg-soft-primary mb-4 overflow-hidden">
                                <div class="card-body d-flex align-items-center justify-content-between p-4 flex-wrap gap-2">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <code class="text-primary fw-bold fs-18 text-break">{{ url('/') }}/api/v1/nin/verify</code>
                                    </div>
                                </div>
                            </div>

                            <p class="text-muted mb-4">
                                Verify a National Identity Number (NIN) by sending a POST request with the NIN number.
                            </p>
...
<pre class="m-0 p-4 text-white font-monospace"><code>{
  <span class="text-muted">// Required. 11 digit NIN</span>
...
<pre class="m-0 p-4 text-white font-monospace"><code>{
  ...
  <span class="text-info">"data"</span>: {
    ...
    <span class="text-info">"surname"</span>: <span class="text-warning">"GARBA"</span>,
    <span class="text-muted">// ... other details</span>
  },
  <span class="text-info">"transaction_ref"</span>: <span class="text-warning">"Ver-123..."</span>
}</code></pre>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="card-body p-5">
                            ...
                            <div class="alert alert-warning border border-warning border-opacity-25 rounded-3 d-flex align-items-start p-4 mb-4" role="alert">
                                ...
                                <div>
                                    ...
                                    <p class="mb-0 ">
                                        Please note that some responses are chargeable even if the NIN is not found. Review the table below carefully.
                                    </p>
                                </div>
                            </div>
                                ...
                                <table class="table table-premium table-hover align-middle mb-0">
                                    ...
                                    <tbody class="border-top-0">
                                        ...
                                        <tr>
                                            ...
                                            <td class=" fw-medium">NIN does not exist</td>
    ...
    <style>
        ...
        .sidebar-nav-header { 
            ...
            border-bottom: 1px solid #fee0d2;
        }
        .sidebar-nav-header h6, .sidebar-nav-header h5 { color: #f26922 !important; }
        .dark-mode .sidebar-nav-header {
            background-color: rgba(242, 105, 34, 0.08) !important;
            border-bottom: 1px solid rgba(242, 105, 34, 0.15) !important;
        }
        .dark-mode .sidebar-nav-header h6, .dark-mode .sidebar-nav-header h5 { color: #ff9b6a !important; }
