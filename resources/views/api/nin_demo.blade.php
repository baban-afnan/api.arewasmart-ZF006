<x-app-layout>
    <title>Arewa Smart - {{ $title ?? 'NIN Demo Verification API' }}</title>
            ...
            <div class="row align-items-center">
                <div class="col">
                    ...
                    <p class="text-muted mb-0">
                        View and manage NIN Demo (Demographic) Verification API requests
                    </p>
                </div>
                            ...
                            <div class="card-body p-0">
                                ...
                                <div class="list-group list-group-flush custom-sidebar-nav p-3">
                                    ...
                                    <a class="list-group-item list-group-item-action border-0 mb-2 px-3 py-2 d-flex align-items-center" href="#endpoint" onclick="switchTab('endpoint'); return false;">
                                        <i class="ti ti-server me-2 opacity-75 fs-15"></i> Demo Endpoint
                                    </a>
                ...
                <div class="offcanvas-body p-0">
                    <div class="list-group list-group-flush custom-sidebar-nav p-3">
                        ...
                        <a class="list-group-item list-group-item-action border-0 mb-2 px-3 py-2 d-flex align-items-center" href="#endpoint" onclick="switchTab('endpoint'); closeOffcanvas(); return false;">
                            <i class="ti ti-server me-2 fs-15"></i> Demo Endpoint
                        </a>
                ...
                <div class="docs-section fade-in" id="overview">
                    <div class="card border-0 shadow-sm rounded-4 mb-4 position-relative overflow-hidden">
                        ...
                        <div class="card-body p-5 position-relative">
                            ...
                            <h2 class="fw-bold  mb-3">NIN Demo Integration Guide</h2>
                            <p class="text-muted lead mb-4">
                                Our NIN Demo (Demographic) verification service allows you to retrieve full identity details using basic information like name and date of birth. 
                                This is ideal for scenarios where a physical NIN card is not present.
                            </p>
                    ...
                    <div class="alert alert-success border border-success border-opacity-25 rounded-3 d-flex align-items-start p-4 mb-4" role="alert">
                        ...
                        <div>
                            ...
                            <p class="mb-0 ">
                                You will be charged <span class="fw-bold">₦{{ number_format($price ?? 0, 2) }}</span> per successful verification.
                ...
                <div class="docs-section d-none fade-in" id="auth">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <button class="btn btn-primary d-inline-flex btn-lg align-items-center shadow-sm next-tab-btn" data-next="endpoint">
                            Next: Demo Endpoint <i class="ti ti-arrow-right ms-2 fs-15"></i>
                        </button>
                    </div>
                </div>
                            ...
                            <div class="card border-0 bg-soft-primary mb-4 overflow-hidden">
                                <div class="card-body d-flex align-items-center justify-content-between p-4 flex-wrap gap-2">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <code class="text-primary fw-bold fs-18 text-break">{{ url('/') }}/api/v1/nin/demo</code>
                                    </div>
                                </div>
                            </div>

                            <p class="text-muted mb-4">
                                Verify identity details by sending a demographic query.
                            </p>
                                ...
                                <div class="col-lg-6">
                                    <div class="card h-100 border shadow-sm rounded-4 overflow-hidden">
                                        <div class="card-header bg-theme-subtle border-bottom border-theme py-3">
                                            <h6 class="fw-bold text-main mb-0">Request Payload</h6>
                                        </div>
                                        <div class="card-body p-0 bg-dark">
<pre class="m-0 p-4 text-white font-monospace"><code>{
  <span class="text-info">"firstName"</span>: <span class="text-warning">"BOLA"</span>,
  <span class="text-info">"lastName"</span>: <span class="text-warning">"AHMED"</span>,
  <span class="text-info">"gender"</span>: <span class="text-warning">"M"</span>,
  <span class="text-info">"dateOfBirth"</span>: <span class="text-warning">"20-02-1966"</span>,
  <span class="text-info">"ref"</span>: <span class="text-warning">"test_ref_123"</span>
}</code></pre>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="card h-100 border shadow-sm rounded-4 overflow-hidden">
                                        <div class="card-header bg-theme-subtle border-bottom border-theme py-3">
                                            <h6 class="fw-bold text-success mb-0">Example Success Response</h6>
                                        </div>
                                        <div class="card-body p-0 bg-dark">
<pre class="m-0 p-4 text-white font-monospace"><code>{
  <span class="text-info">"status"</span>: <span class="text-warning">true</span>,
  <span class="text-info">"message"</span>: <span class="text-warning">"NIN Verification Successful"</span>,
  <span class="text-info">"data"</span>: {
    <span class="text-info">"reference"</span>: <span class="text-warning">"NIND12345ABCDE"</span>,
    <span class="text-info">"firstname"</span>: <span class="text-warning">"JOHN"</span>,
    <span class="text-info">"surname"</span>: <span class="text-warning">"DOE"</span>,
    <span class="text-info">"middlename"</span>: <span class="text-warning">"PETER"</span>,
    <span class="text-info">"gender"</span>: <span class="text-warning">"m"</span>,
    <span class="text-info">"nin"</span>: <span class="text-warning">"12345678901"</span>,
    <span class="text-info">"birthdate"</span>: <span class="text-warning">"22-02-1990"</span>,
    <span class="text-info">"telephoneno"</span>: <span class="text-warning">"08012345678"</span>,
    <span class="text-info">"photo_path"</span>: <span class="text-warning">"/9j/4AAQSkZ..."</span>,
    <span class="text-info">"signature_path"</span>: <span class="text-warning">"/9j/4AAQSkZ..."</span>,
    <span class="text-info">"trackingId"</span>: <span class="text-warning">"TRK123456789Z"</span>,
    <span class="text-info">"status"</span>: <span class="text-warning">"successful"</span>,
    <span class="text-info">"amount"</span>: <span class="text-warning">"50.00"</span>,
    <span class="text-info">"created_at"</span>: <span class="text-warning">"2026-02-01T12:00:00.000000Z"</span>
  }
}</code></pre>
                        ...
                        <div class="card-body p-5">
                            ...
                            <div class="alert alert-warning border border-warning border-opacity-25 rounded-3 d-flex align-items-start p-4 mb-4" role="alert">
                                ...
                                <div>
                                    ...
                                    <p class="mb-0 ">
                                        Charges are only applied for successful API responses from the upstream provider.
                                    </p>
                                </div>
                            </div>
                                ...
                                <table class="table table-hover align-middle mb-0">
                                    <thead class="bg-theme-subtle">
                                        <tr class="text-uppercase small text-muted">
                                            <th class="py-3 ps-4 border-theme">HTTP Status</th>
                                            <th class="py-3 border-theme">Status Field</th>
                                    ...
                                    <tbody class="border-top-0">
                                        <tr>
                                            <td class="ps-4"><code>200 OK</code></td>
                                            <td><span class="badge bg-soft-success text-success">true</span></td>
                                            <td class=" fw-medium">Successful Retrieval</td>
                                            <td class="text-end pe-4"><span class="badge bg-danger">Charged</span></td>
                                        </tr>
                                        <tr>
                                            <td class="ps-4"><code>400</code></td>
                                            <td><span class="badge bg-soft-warning text-warning">false</span></td>
                                            <td class=" fw-medium">Invalid Parameters / Not Found</td>
                                            <td class="text-end pe-4"><span class="badge bg-success">Free</span></td>
                                        </tr>
                                        <tr>
                                            <td class="ps-4"><code>401</code></td>
                                            <td><span class="badge bg-light ">error</span></td>
                                            <td class=" fw-medium">Unauthorized Access</td>
                                            <td class="text-end pe-4"><span class="badge bg-success">Free</span></td>
                                        </tr>
                                        <tr>
                                            <td class="ps-4"><code>503</code></td>
                                            <td><span class="badge bg-light ">false</span></td>
                                            <td class=" fw-medium">NO RECORD FOUND</td>
                                            <td class="text-end pe-4"><span class="badge bg-success">Free</span></td>
                                        </tr>
                                    </tbody>
                                </table>
