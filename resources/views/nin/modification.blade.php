                ...
                <div class="docs-section fade-in" id="overview">
                    <div class="card border-0 shadow-sm rounded-4 mb-4 position-relative overflow-hidden">
                        ...
                        <div class="card-body p-5 position-relative">
                            ...
                            <h2 class="fw-bold text-dark mb-3">NIN Modification Guide</h2>
                                    ...
                                    <tbody class="border-top-0">
                                        ...
                                        @foreach($listedServices as $item)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <code class="bg-light text-primary border rounded px-2 py-1 fw-bold fs-14">{{ $item['code'] }}</code>
                                                </td>
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <ul class="list-group list-group-flush mb-3">
                                        <li class="list-group-item px-0"><span class="fw-bold">field_code</span> <span class="text-danger">*</span>: (string) Service ID e.g., "032".</li>
                                        <li class="list-group-item px-0"><span class="fw-bold">nin</span> <span class="text-danger">*</span>: (string) 11-digit NIN.</li>
                                        <li class="list-group-item px-0"><span class="fw-bold">description</span>: (string) Optional note.</li>
                                        <li class="list-group-item px-0"><span class="fw-bold">modification_data</span> <span class="text-danger">*</span>: (JSON) Data details.</li>
                                    </ul>
                                </div>
                                        ...
                                        <div class="tab-pane fade show active" id="payload-gen">
                                             <div class="card h-100 border shadow-sm rounded-4 overflow-hidden">
                                                <div class="card-header bg-light border-bottom py-3 d-flex justify-content-between">
                                                    <h6 class="fw-bold text-dark mb-0">Name/Phone Update</h6>
                                                    <button class="btn btn-sm btn-outline-primary copy-btn" data-clipboard-target="#code-gen"><i class="ti ti-clipboard"></i> Copy</button>
                                                </div>
  ...
  "description": {
    ...
    "reason": "Old line lost"
                                        ...
                                        <div class="tab-pane fade" id="payload-dob">
                                             <div class="card h-100 border shadow-sm rounded-4 overflow-hidden">
                                                <div class="card-header bg-light border-bottom py-3 d-flex justify-content-between">
                                                    <h6 class="fw-bold text-dark mb-0">DOB Modification</h6>
                                                    <button class="btn btn-sm btn-outline-primary copy-btn" data-clipboard-target="#code-dob"><i class="ti ti-clipboard"></i> Copy</button>
                                                </div>
                                                <div class="card-body p-0 bg-dark">
<pre class="m-0 p-4 text-white font-monospace" style="max-height: 400px; overflow-y: auto;" id="code-dob"><code>{
    ...
    "description": {
        ...
        "residence_address": "No 123 Some Street",
        "phone_number": "08012345678",
        "place_of_birth": "Aminu Kano Hospital",
        "state_of_birth": "Kano",
        "lga_of_birth": "Nassarawa",
        "occupation": "Student",
        "education_level": "Primary",
        "occupation_address": "School Address",
        "father_surname": "Musa",
        "father_firstname": "Ali",
        "father_town": "Gama",
        "father_state": "Kano",
        "father_lga": "Nassarawa",
        "mother_surname": "Sani",
        "mother_firstname": "Fatima",
        "mother_town": "Gama",
        "mother_state": "Kano",
        "mother_lga": "Nassarawa",
        "reg_state": "Kano",
        "reg_lga": "Nassarawa",
