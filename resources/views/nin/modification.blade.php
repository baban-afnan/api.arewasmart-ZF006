<x-app-layout>
    <title>Arewa Smart - {{ $title ?? 'NIN Modification API' }}</title>
            ...
            <div class="row align-items-center">
                <div class="col">
                    ...
                    <p class="text-muted mb-0">
                        Automate NIN Data Modification requests including DOB, Name, and Phone updates.
                    </p>
                </div>
                <div class="col-auto">
                ...
                <div class="docs-section fade-in" id="overview">
                    <div class="card border-0 shadow-sm rounded-4 mb-4 position-relative overflow-hidden">
                        ...
                        <div class="card-body p-5 position-relative">
                            ...
                            <h2 class="fw-bold mb-3">NIN Modification Guide</h2>
                            <p class="text-muted lead mb-4">
                                Seamlessly integrate NIN Modification services into your application. 
                                Support for Name Correction, DOB Updates (Under 5), Phone Number Changes, and Residence Address Updates.
                            </p>
                            ...
                            <div class="bg-dark rounded-4 p-4 text-white shadow-lg position-relative overflow-hidden">
                                ...
                                <div class="mt-3 d-flex align-items-center small text-warning">
                                    <i class="ti ti-alert-world me-2 fs-15"></i>
                            ...
                            <h4 class="fw-bold  mb-4 d-flex align-items-center">
                             ...
                             <div class="alert alert-info border border-info border-opacity-25 rounded-3 d-flex align-items-start p-4 mb-4" role="alert">
                                ...
                                <div>
                                    ...
                                    <p class="mb-0">
                                        The <strong>Field Code</strong> is mandatory for identifying the type of modification.
                                        Prices listed are specific to your account level.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="table-responsive rounded-3 border custom-table-border">
                                <table class="table table-premium table-hover align-middle mb-0">
                                    ...
                                    <tbody class="border-top-0">
                                        @php
                                            $listedServices = [
                                                ['code' => '032', 'name' => 'Correction of Name'],
                                                ['code' => '033', 'name' => 'Phone Number Update'],
                                                ['code' => '034', 'name' => 'Gender Update'],
                                                ['code' => '035', 'name' => 'Date of Birth Update (< 5 Years)'],
                                                ['code' => '037', 'name' => 'Change of Residence Address'],
                                            ];
                                        @endphp

                                        @foreach($listedServices as $item)
                                            @php
                                                $service = $services->firstWhere('code', $item['code']);
                                                $price = $service ? $service->price : null;
                                            @endphp
                                            <tr>
                                                <td class="ps-4 fw-medium">{{ $item['name'] }}</td>
                                                <td>
                                                    <span class="badge bg-indigo-soft text-indigo border border-indigo border-opacity-10 py-2 px-3 rounded-pill">Modification</span>
                                                </td>
                                                <td>
                                                    <code class="text-primary border rounded px-2 py-1 fw-bold fs-14">{{ $item['code'] }}</code>
                                                </td>
                    ...
                    <div class="card border-0 shadow-sm rounded-4 mb-4">
                        <div class="card-body p-5">
                            ...
                            <div class="mb-5">
                                ...
                                <div class="form-text mt-2"><i class="ti ti-lock me-1 fs-15"></i> Keep this token safe!</div>
                            </div>
                            ...
                            <div class="card border-0 bg-soft-primary mb-4 overflow-hidden">
                                <div class="card-body d-flex align-items-center justify-content-between p-4 flex-wrap gap-2">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <code class="text-primary fw-bold fs-18 text-break">{{ url('/') }}/api/v1/nin/modification</code>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <ul class="list-group list-group-flush mb-3">
                                        <li class="list-group-item bg-transparent text-body px-0 border-opacity-10 border-white"><span class="fw-bold">field_code</span> <span class="text-danger">*</span>: (string) Service ID e.g., "032".</li>
                                        <li class="list-group-item bg-transparent text-body px-0 border-opacity-10 border-white"><span class="fw-bold">nin</span> <span class="text-danger">*</span>: (string) 11-digit NIN.</li>
                                        <li class="list-group-item bg-transparent text-body px-0 border-opacity-10 border-white"><span class="fw-bold">description</span> <span class="text-danger">*</span>: (string) Provide new modification details here (max 1000 chars).</li>
                                        <li class="list-group-item bg-transparent text-body px-0 border-opacity-10 border-white border-bottom-0"><span class="fw-bold">modification_data</span>: (JSON) Optional. Additional structured data.</li>
                                    </ul>
                                </div>
                                ...
                                <div class="col-12 mt-2">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane fade show active" id="payload-gen">
                                             <div class="card h-100 border shadow-sm rounded-4 overflow-hidden">
                                                <div class="card-header border-bottom py-3 d-flex justify-content-between">
                                                    <h6 class="fw-bold mb-0">Name/Phone Update</h6>
                                                    <button class="btn btn-sm btn-outline-primary copy-btn" data-clipboard-target="#code-gen"><i class="ti ti-clipboard fs-15"></i> Copy</button>
                                                </div>
                                                <div class="card-body p-0 bg-dark">
<pre class="m-0 p-4 text-white font-monospace" id="code-gen"><code>{
  "field_code": "033",
  "nin": "12345678901",
  "description": "Please update phone number to 08012345678. Reason: Old line lost."
}</code></pre>
                                                </div>
                                            </div>
                                        </div>
                                        
                                        <div class="tab-pane fade" id="payload-dob">
                                             <div class="card h-100 border shadow-sm rounded-4 overflow-hidden">
                                                <div class="card-header border-bottom py-3 d-flex justify-content-between">
                                                    <h6 class="fw-bold mb-0">DOB Modification</h6>
                                                    <button class="btn btn-sm btn-outline-primary copy-btn" data-clipboard-target="#code-dob"><i class="ti ti-clipboard fs-15"></i> Copy</button>
                                                </div>
                                                <div class="card-body p-0 bg-dark">
<pre class="m-0 p-4 text-white font-monospace" style="max-height: 400px; overflow-y: auto;" id="code-dob"><code>{
    "field_code": "035",
    "nin": "12345678901",
    "description": "Name: Ibrahim Musa Ali, Gender: Male, New DOB: 2020-05-15, Nationality: Nigeria, State of Origin: Kano, Phone: 08012345678. Requesting DOB modification."
}</code></pre>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="tab-pane fade" id="payload-response">
                                             <div class="card h-100 border shadow-sm rounded-4 overflow-hidden">
                                                <div class="card-header border-bottom py-3 d-flex justify-content-between">
                                                    <h6 class="fw-bold mb-0">Sample Response</h6>
                             ...
                             <div class="card border-0 bg-soft-success mb-4 overflow-hidden">
                                <div class="card-body d-flex align-items-center justify-content-between p-4 flex-wrap gap-2">
                                     <div class="d-flex align-items-center">
                                        ...
                                        <code class="text-success fw-bold fs-18 text-break">{{ url('/') }}/api/v1/nin/modification</code>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="card-body p-4">
                                            <ul class="list-unstyled mb-0 font-monospace">
                                                ...
                                                <li>
                                                    ...
                                                    <strong>?reference=</strong><span class="text-muted">M1XYZ...</span>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
