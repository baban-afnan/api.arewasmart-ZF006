                ...
                <div class="docs-section fade-in" id="overview">
                    <div class="card border-0 shadow-sm rounded-4 mb-4 position-relative overflow-hidden">
                        ...
                        <div class="card-body p-5 position-relative">
                            ...
                            <h2 class="fw-bold text-dark mb-3">Data Bundle API Guide</h2>
                ...
                <div class="docs-section d-none fade-in" id="auth">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <button class="btn btn-primary d-inline-flex btn-lg align-items-center shadow-sm next-tab-btn" data-next="variations">
                            Next: Fetching Data Plans <i class="ti ti-arrow-right ms-2"></i>
                        </button>
                    </div>
                </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="table-responsive rounded-3 border mb-4">
                                        <table class="table table-hover align-middle mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="ps-4 fw-bold">network</td>
                                                    <td>String</td>
                                                    <td>Optional</td>
                                                    <td class="pe-4">Filter by network (mtn-data, airtel-data, glo-data, etisalat-data)</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
...
<pre class="m-0 p-4 text-white font-monospace"><code>{
  ...
  <span class="text-info">"data"</span>: {
    ...
    <span class="text-info">"status"</span>: <span class="text-warning">"completed"</span>
                                    ...
                                    <h6 class="fw-bold text-dark mt-4 mb-3">Error Response (400)</h6>
                 ...
                 <div class="docs-section d-none fade-in" id="codes">
                    <div class="card border-0 shadow-sm rounded-4 mb-4">
                        <div class="card-body p-5">
                            ...
                            <div class="mt-4">
                                <div class="alert alert-info border border-info border-opacity-25 rounded-4 d-flex align-items-start p-4 mb-0" role="alert">
                                    <i class="ti ti-info-circle fs-4 me-3 mt-1 text-info"></i>
                                    <div>
                                        <h6 class="fw-bold text-dark mb-2">How Commission Works:</h6>
