<x-app-layout>
    <title>Arewa Smart - {{ $title ?? 'Airtime Purchase API' }}</title>
            ...
            <div class="row align-items-center">
                <div class="col">
                    ...
                    <p class="text-muted mb-0">
                        Integrate Airtime Vending directly into your application.
                    </p>
                </div>
                <div class="col-auto">
                ...
                <div class="docs-section d-none fade-in" id="auth">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <button class="btn btn-primary d-inline-flex btn-lg align-items-center shadow-sm next-tab-btn" data-next="endpoint">
                            Next: Purchase Endpoint <i class="ti ti-arrow-right ms-2"></i>
                        </button>
                    </div>
                </div>
                            ...
                            <div class="card border-0 bg-soft-primary mb-4 overflow-hidden">
                                <div class="card-body d-flex align-items-center justify-content-between p-4 flex-wrap gap-2">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <code class="text-primary fw-bold fs-18 text-break">{{ url('/') }}/api/v1/airtime/purchase</code>
                                    </div>
                                </div>
                            </div>
...
<pre class="m-0 p-4 text-white font-monospace"><code>{
  <span class="text-info">"network"</span>: <span class="text-warning">"102"</span>, 
  ...
  <span class="text-info">"request_id"</span>: <span class="text-warning">"UNIQUE_REF_771051eff7"</span> 
}</code></pre>
                                        </div>
                                    </div>
                                </div>
...
<pre class="m-0 p-4 text-white font-monospace"><code>{
  ...
  <span class="text-info">"message"</span>: <span class="text-warning">"Airtime purchase successful"</span>,
  <span class="text-info">"data"</span>: {
    <span class="text-info">"transaction_ref"</span>: <span class="text-warning">"202601178363249"</span>,
    <span class="text-info">"request_id"</span>: <span class="text-warning">"UNIQUE_REF_771051eff7"</span>,
    <span class="text-info">"network"</span>: <span class="text-warning">"102"</span>,
    <span class="text-info">"network_name"</span>: <span class="text-warning">"glo"</span>,
    <span class="text-info">"amount"</span>: <span class="text-warning">1000</span>,
    <span class="text-info">"phone"</span>: <span class="text-warning">"07037343660"</span>,
    <span class="text-info">"type"</span>: <span class="text-warning">"Airtime Recharge"</span>,
    <span class="text-info">"email"</span>: <span class="text-warning">"ourapiemail@gmail.com"</span>,
    <span class="text-info">"commission_earned"</span>: <span class="text-warning">100</span>,
    <span class="text-info">"new_balance"</span>: <span class="text-warning">14617</span>,
    <span class="text-info">"trans_source"</span>: <span class="text-warning">"api"</span>,
    <span class="text-info">"status"</span>: <span class="text-warning">"completed"</span>
                     ...
                     <div class="d-flex justify-content-between">
                        ...
                        <button class="btn btn-primary d-inline-flex btn-lg align-items-center shadow-sm next-tab-btn" data-next="codes">
                            Next: Network Codes <i class="ti ti-arrow-right ms-2"></i>
                        </button>
                    </div>
                </div>

                 <!-- Networks & Commissions Section -->
    ...
    @push('scripts')
    <script>
        // Tab switching logic (Same as BVN)
        function switchTab(tabId) {
            document.querySelectorAll('.docs-section').forEach(section => {
                // Ensure strict mode for hiding
            ...
            // Re-hide others with class (redundant but safe)
             document.querySelectorAll('.docs-section').forEach(section => {
